    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            <div class="stat-card-header">
                <span class="stat-card-label">Calls</span>
            ...
            <div class="stat-card-value">{{ $this->totalCalls }}</div>
            <div class="stat-card-sub">(In {{ $this->inboundCalls }} | Out {{ $this->outboundCalls }})</div>
        </div>
        ...
        <div class="stat-card">
            <div class="stat-card-header">
                <span class="stat-card-label">Waiting</span>
                <span class="stat-icon icon-orange">
                    <svg style="width:20px;height:20px;color:#fb923c;flex-shrink:0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none">
                        <path d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,22A10,10,0,1,1,22,12,10.011,10.011,0,0,1,12,22Zm3.707-6.293a1,1,0,0,1-1.414,1.414l-3-3A1,1,0,0,1,11,13V7a1,1,0,0,1,2,0v5.586Z"/>
                    </svg>
                </span>
            </div>
            <div class="stat-card-value">{{ $this->waitingCalls }}</div>
        </div>
